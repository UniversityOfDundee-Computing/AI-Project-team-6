async function aStarSearch(problem) {
    ...
    while (true) {
        ...
        for (let i = 0; i < actions.length; i++) {
            ...
            //     var nodeInFrontier = frontierList.filter(e => { return e.state.x == childNode.state.x && e.state.y == childNode.state.y})[0];
            //     frontierList.splice(frontierList.indexOf(nodeInFrontier), 1);
